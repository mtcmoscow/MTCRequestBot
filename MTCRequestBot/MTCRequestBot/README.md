...
Bot Framework v4 core bot sample. 
  - Add PR quality check. 
  - Add Unit Test Result as a PR comment.
...
- In a terminal, navigate to `MTCRequestBot`
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `MTCRequestBot` folder
  - Select `MTCRequestBot.csproj` file
